...
@WebServlet("/ThemThiSinhVaoLop")
public class ThemThiSinhVaoLop extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ThemThiSinhVaoLop() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean cddInClassError = CandidateDAO.insertCddToClass(new ClassEntry(classId), new CandidateEntry(cddId));
