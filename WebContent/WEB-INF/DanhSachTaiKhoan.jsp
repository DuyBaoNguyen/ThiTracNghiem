...
<body>
    ...
    <div class="main-container">
        <div class="func-container">
             <form action="${pageContext.request.contextPath}/DanhSachTaiKhoan" method="get">
            ...
            <a href="${pageContext.request.contextPath}/ThemTaiKhoan" class="add-btn func-btn">Thêm</a>
            <a href="${pageContext.request.contextPath}/DanhSachTaiKhoan" class="refresh-btn func-btn">Làm mới</a>
        </div>
        <hr>
                	...
                	<c:forEach var="acc" items="${accs}">
	                    <tr>
	                        <td>${acc.username}</td>
                       		<td>${acc.user.name}</td>
	                      	<td>
	                            <button type="button" class="del-btn sub-func-btn" onclick="delAccount('${acc.username}')">Xóa</button>
	                            <a href="${pageContext.request.contextPath}/DoiMatKhau?username=${acc.username}" class="update-btn sub-func-btn">Đổi mật khẩu</a>
	                        </td>
	                    </tr>
	               	</c:forEach>
                </tbody>
    ...
    <script>
        function delAccount(username) {
            if (window.confirm("Bạn chắc chắn muốn xóa?")) {
                window.location = "${pageContext.request.contextPath}/XoaTaiKhoan?username=" + username;
            }
        }
    </script>

	<c:if test="${accError == true}">
	    <script>
