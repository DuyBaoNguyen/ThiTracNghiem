...
<body>
    ...
    <div class="main-container">
        <div class="main-content">
            <form action="${pageContext.request.contextPath}/ThemNguoiDung" method="post" accept-charset="UTF-8">
                ...
                <input type="text" name="userAddress" autocomplete="off">
                <br>
                <h5 class="sub-title">Ngày sinh</h5>
                <input type="date" name="userBirthday">
                <br>
                <h5 class="sub-title">Số điện thoại</h5>
                <input type="text" name="userPhone" autocomplete="off" maxlength="10">
                <br>
