...
<body>
    <div class="left-menu-container">
        ...
        <div class="left-menu">
			...
			<a class="menu-item" id="active-item" href="${pageContext.request.contextPath}/DoiMatKhauNguoiDung">
				<div class="icon-container">
    ...
    <div class="main-container">
        <div class="main-content">
        	<form id="account-info" action="${pageContext.request.contextPath}/DoiMatKhauNguoiDung" method="post" onsubmit="return isValidForm()">
