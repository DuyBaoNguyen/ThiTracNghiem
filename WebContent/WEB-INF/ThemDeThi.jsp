...
<body>
	...
	<div class="top-nav">
		<h3 class="title">Thêm đề thi</h3>
	</div>
	<div class="main-container">
		<div class="main-content">
			<div class="main-content">
				<form action="${pageContext.request.contextPath}/ThemDeThi"
					...
					<input type="text" name="totalTime" required autocomplete="off">
					<br>
					<c:forEach var="typeQuestion" items="${typeQuestions}">
						<h5 class="sub-title">Số câu hỏi ${typeQuestion.name}</h5>
						<input type="hidden" name="typeQuestion${typeQuestion.id}" value="${typeQuestion.id}">
						<input type="text" name="totalQuestion${typeQuestion.id}" required autocomplete="off">
						<br>
					</c:forEach>
