...
<body>
    <div class="left-menu-container">
        ...
        <div class="left-menu">
            ...
            <a class="menu-item" id="active-item" href="${pageContext.request.contextPath}/DanhSachLinhVuc">
                <div class="icon-container">
    ...
    <div class="main-container">
        <div class="func-container">
            <form action="${pageContext.request.contextPath}/DanhSachLinhVuc" method="get">
            ...
            <a href="${pageContext.request.contextPath}/ThemLinhVuc" class="add-btn func-btn">Thêm</a>
            <a href="${pageContext.request.contextPath}/DanhSachLinhVuc" class="refresh-btn func-btn">Làm mới</a>
        </div>
        <hr>
                	...
                	<c:forEach var="field" items="${fields}">
	                    <tr>
	                        ...
	                        <td>
	                            ...
	                            <a href="${pageContext.request.contextPath}/SuaLinhVuc?fieldId=${field.id}" class="update-btn sub-func-btn">Sửa</a>
	                        </td>
	                    </tr>
                    </c:forEach>
                </tbody>
    ...
    <script>
        function delField(fieldId) {
            if (window.confirm("Bạn chắc chắn muốn xóa?")) {
                window.location = "${pageContext.request.contextPath}/XoaLinhVuc?fieldId=" + fieldId;
            }
        }
    </script>

	<c:if test="${fieldError == true}">
	    <script>
