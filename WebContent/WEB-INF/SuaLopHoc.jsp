...
<body>
    ...
    <div class="top-nav">
        <h3 class="title">Sửa lớp học</h3>
    </div>
    <div class="main-container">
        <div class="main-content">
            <form action="${pageContext.request.contextPath}/SuaLopHoc" method="post" accept-charset="UTF-8">
            	<h5 class="sub-title">Mã lớp học</h5>
                <input type="text" name="classId" value="${entry.id}" readonly>
                <h5 class="sub-title">Tên lớp học</h5>
                <input type="text" name="className" value="${entry.name}" required autocomplete="off">
                <br>
                <h5 class="sub-title">Lĩnh vực</h5>
                <select name="fieldId">
                	<c:forEach var="field" items="${fields}">
                		<c:choose>
	                    	<c:when test="${entry.field.id == field.id}">
