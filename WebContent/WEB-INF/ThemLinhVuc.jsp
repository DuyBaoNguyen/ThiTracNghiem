...
<body>
    ...
    <div class="top-nav">
        <h3 class="title">Thêm lĩnh vực</h3>
    </div>
    <div class="main-container">
        <div class="main-content">
            <form action="${pageContext.request.contextPath}/ThemLinhVuc" method="post" accept-charset="UTF-8">
                <h5 class="sub-title">Tên lĩnh vực</h5>
                <input type="text" name="fieldName" required autocomplete="off">
