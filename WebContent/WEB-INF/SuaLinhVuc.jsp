...
<body>
    ...
    <div class="top-nav">
        <h3 class="title">Sửa lĩnh vực</h3>
    </div>
    <div class="main-container">
        <div class="main-content">
            <form action="${pageContext.request.contextPath}/SuaLinhVuc" method="post" accept-charset="UTF-8">
                <input type="hidden" name="fieldId" value="${field.id}">
                <h5 class="sub-title">Tên lĩnh vực</h5>
                <input type="text" name="fieldName" value="${field.name}" required autocomplete="off">
