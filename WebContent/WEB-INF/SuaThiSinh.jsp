...
<body>
    ...
    <div class="top-nav">
        <h3 class="title">Sửa thí sinh</h3>
    </div>
    <div class="main-container">
        <div class="main-content">
            <form action="${pageContext.request.contextPath}/SuaThiSinh" method="post" accept-charset="UTF-8">
                <h5 class="sub-title">Mã thí sinh</h5>
                <input type="text" name="cddId" value="${cdd.id}" readonly>
                <h5 class="sub-title">Họ tên</h5>
                <input type="text" name="cddName" value="${cdd.name}" required autocomplete="off">
                <br>
                <h5 class="sub-title">Giới tính</h5>
                
                <label class="">
                    <input type="radio" name="cddSex" value="male" checked
                    	<c:if test="${cdd.sex == true}">
                    		checked
                    	</c:if>>
                    Nam
                </label>
                ...
                <input type="text" name="cddAddress" value="${cdd.address}" autocomplete="off">
                <br>
                <h5 class="sub-title">Ngày sinh</h5>
                <input type="date" name="cddBirthday" value="${cdd.birthday}">
                <br>
                <h5 class="sub-title">Số điện thoại</h5>
                <input type="text" name="cddPhone" value="${cdd.phone}" autocomplete="off" maxlength="10">
                <br>
